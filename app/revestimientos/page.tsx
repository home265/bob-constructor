    ...
    <div className="grid md:grid-cols-2 gap-4">
      ...
      <ResultTable
        ...
        items={(function (): ResultRow[] {
          ...
          if (res?.modulo_m2 != null) out.push({ label: "Módulo (pieza + junta)", qty: res.modulo_m2, unit: "m²" });
          if (res?.piezas_necesarias != null) out.push({ label: "Piezas necesarias", qty: res.piezas_necesarias, unit: "ud" });
          if (res?.piezas_con_desperdicio != null) out.push({ label: "Piezas con desperdicio", qty: res.piezas_con_desperdicio, unit: "ud" });
          if (res?.cajas != null) out.push({ label: "Cajas", qty: res.cajas, unit: "ud" });
